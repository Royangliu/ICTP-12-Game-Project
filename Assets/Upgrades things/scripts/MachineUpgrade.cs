...
public class MachineUpgrade : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void getUpgrade()
    {
        if (UpgradeVariables.money >= cost)
        {
            ...
            UpgradeVariables.upgradeStations = true;
        }
    }
    ...
    {
        if (UpgradeVariables.upgradeStations) // change
        {
