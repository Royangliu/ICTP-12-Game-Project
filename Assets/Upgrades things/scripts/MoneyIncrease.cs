...
public class MoneyIncrease : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void getUpgrade()
    {
        if (UpgradeVariables.money >= cost)
        {
            ...
            UpgradeVariables.upgradePay = true;
        }
    }
    ...
    {
        if (UpgradeVariables.upgradePay) // change
        {
