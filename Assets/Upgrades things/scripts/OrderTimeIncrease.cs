...
public class OrderTimeIncrease : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void getUpgrade()
    {
        if (UpgradeVariables.money >= cost)
        {
            ...
            UpgradeVariables.upgradeOrderTimeLimit = true;
        }
    }
    ...
    {
        if (UpgradeVariables.upgradeOrderTimeLimit) // change
        {
