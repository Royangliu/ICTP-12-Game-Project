...
public class TrashUpgrade : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void getUpgrade()
    {
        if (UpgradeVariables.money >= cost)
        {
            ...
            UpgradeVariables.upgradeTrash = true;
        }
    }
    ...
    {
        if (UpgradeVariables.upgradeTrash) // change
        {
