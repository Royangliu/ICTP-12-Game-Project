...
public class UpgradeTables : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void getUpgrade()
    {
        if (UpgradeVariables.money >= cost)
        {
            ...
            UpgradeVariables.upgradeTables = true;
        }
    }
    ...
    {
        if (UpgradeVariables.upgradeTables) // change
        {
